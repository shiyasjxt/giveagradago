...
!(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".homepage-job #myJobsList").includeFeed({
            ...
            templates: {
                itemTemplate: "<div class='job-box'><h4><a href='{{link}}'>{{title}}</a></h4><div class='sal'>&pound;{{salaryLowerBand}} <span>-</span> &pound;{{salaryUpperBand}}</div><div class='desc'>{{description}}</div></div>"
            },
            ...
            $(".inner-joblist #myJobsList").includeFeed({
                ...
                templates: {
                    ...
                    <div class='locandsalary'>\n\
                        ...
                        <div class='labels-wrapper'><span class='labels worktype-label'>Salary</span><span class='jxt-result-sal'><span class='sal'>&pound;{{salaryLowerBand}} <span>-</span> &pound;{{salaryUpperBand}}</span></span></div>\n\
                    </div>\n\
                </div>"
                },
                /*elements: { title: 1, description: 1 },*/
        ...
        //boost page
        $(".inner-banner .container").append($(".dynamic-content-holder .banner-cont"));
        ...
        bootstrapModal("#myModalBoost", "#myBoost", ".close");
        bootstrapModal("#myModalBoost1", "#myBoost1", ".close");
        bootstrapModal("#myModalBoost2", "#fb-submit-button", ".close");


        $("#fb-submit-button").click(function () {

            var bootName = $('#boostName').val(),
                booEmail = $('#boostEmail').val(),
                bootPara = '?extid=' + '&name=' + bootName + '&email=' + booEmail;

            $('#passValue').attr('src', '//f.jxt.com.au/FORMS/giveagradago.com/boost-apply_exported/boost-apply.php' + bootPara);
        ...
        $("#myNewsList ul").each(function () {
            var dataURL = $(this).attr("data-url");
            $(this).includeFeed({
                baseSettings: { rssURL: [dataURL || "/NewsRSS.aspx"], limit: 3 },
                templates: {
                    itemTemplate: "<li><div class='rss-item' id='rss-item-{{item-index}}'><span><img src='{{imageurl}}' alt='{{title}}'></span><span class='rss-item-title'><a target='_blank' href='{{link}}'>{{title}}</a></span></a></span></div></li>"
                },
                complete: function () {
                    ...
                    // });
                    //  if ($(this).children().length > 2) {
                    //       $(this).simplyScroll({ frameRate: 15,
        ...
        $("#myBlogList ul").each(function () {
            var dataURL = $(this).attr("data-url");
            $(this).includeFeed({
                baseSettings: { rssURL: [dataURL || "/newsrss.aspx?category=graduate-blog"], limit: 3 },
                templates: {
                    itemTemplate: "<li><div class='rss-item' id='rss-item-{{item-index}}'><span><img src='{{imageurl}}' alt='{{title}}'></span><span class='rss-item-title'><a target='_blank' href='{{link}}'>{{title}}</a></span></a></span></div></li>"
                },
                complete: function () {
...
function CustomFunction(pageurl) {
    ...
    if (pageurl == "member/profile.aspx") {
        ...
        $('input[id*="EducationAddInstitute"], input[id*="EducationInstitute"]').autocomplete({
            source: uniList, minLength: 0
        }).focus(function () {
        ...
        $('input[id*="EducationAddQualificationName"], input[id*="EducationQualificationName"]').autocomplete({
            source: degreeSubj, minLength: 0
        }).focus(function () {
            $(this).autocomplete("search");
        }).blur(function () {
            var isInputContainsInDropDownList = false;
        ...
        $('input[id*="ExperienceAddJobTitle"], input[id*="ExperienceJobTitle"]').autocomplete({
            source: jobRole, minLength: 0
        }).focus(function () {
            $(this).autocomplete("search");
        }).blur(function () {
            var isInputContainsInDropDownList = false;
        ...
        $('input[id*="LanguageName"]').autocomplete({
            source: langList, minLength: 0
        }).focus(function () {
            $(this).autocomplete("search");
        }).blur(function () {
            var isInputContainsInDropDownList = false;
